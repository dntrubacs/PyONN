...
create_optical_images(
    data_path="mnist_raw_data/train-images.idx3-ubyte",
    image_size=(120, 120),
    saved_data_path="mnist_processed_data/train_images",
)
create_optical_labels(
    labels_path="mnist_raw_data/train-labels.idx1-ubyte",
...
create_optical_images(
    data_path="mnist_raw_data/t10k-images.idx3-ubyte",
    image_size=(120, 120),
    saved_data_path="mnist_processed_data/test_images",
)
create_optical_labels(
    labels_path="mnist_raw_data/t10k-labels.idx1-ubyte",
    saved_label_path="mnist_processed_data/test_labels",
)
